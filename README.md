...
I enjoy building scalable web applications, designing efficient APIs, and solving complex problems through code.

🚀 Developing production-ready applications using the **MERN Stack**

✒ Strong problem-solving skills in **Java**, **Object-Oriented Programming**, and **Data Structures & Algorithms**

🔗 Building **RESTful APIs**, authentication systems, and backend services with **Node.js** & **Express.js**

🗄️ Working with **SQL**, **MySQL**, **MongoDB**, **Mongoose ODM** and efficient database design

☁️ Exploring **Cloud Computing**, **Docker**, **Kubernetes**, **CI/CD**, and **DevOps fundamentals**

🎯 Focused on building multiple real-world projects and improving problem solving skills
...
**Tech Stack:** ReactJS, Vite, Tailwind CSS, Shadcn/UI, Radix UI, Lucide React, NodeJS, ExpressJS, MongoDB, Mongoose, Socket.IO, JWT, bcrypt, Razorpay, Axios, Helmet, Chart.js, Docker, Nginx, GitHub Actions, Render.
...
**Tech Stack:** ReactJS, Vite, Tailwind CSS, Shadcn/UI, Lucide React, NodeJS, ExpressJS, MongoDB, Mongoose, Socket.IO, WebRTC, JWT, bcrypt, Zod, Axios, Helmet, Express Rate Limit, Supertest, Render.
...
**Tech Stack:** NodeJS, ExpressJS, EJS, Bootstrap, MongoDB, Mongoose, Passport.js, Razorpay, Cloudinary, Mapbox GL JS, Nodemailer, PDFKit, Multer, Express Session, Connect-Mongo, Joi, JavaScript, HTML, CSS, Render.
